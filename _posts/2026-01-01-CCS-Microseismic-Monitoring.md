...
While data is collected continuously it requires extensive processing to extract meaningful results. Estimation of the plume location is challenging and may carry a high level of uncertainty, which may be above the tolerable level. However, it should be noted that passive seismic for subsurface imaging is further developing.
